...
export default function CourseCategoryPage() {
  ...
  // 2. Format the title beautifully based on the URL
  const formatTitle = (slug) => {
    if (!slug) return "Courses";
    if (slug === "it-technical") return "IT / Technical";
    if (slug === "it-non-technical") return "IT / Non-Technical";
    return slug.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
  };

  // 3. Fetch courses and filter by category
  useEffect(() => {
        ...
        <div className="flex flex-col mb-16 lg:mb-24 border-b border-zinc-200 pb-12">
          <motion.div
            ...
            <p className="text-blue-600 font-bold text-sm tracking-[0.2em] uppercase mb-6">
              Department of {formatTitle(categorySlug)}
            </p>
            <h1 className="text-3xl md:text-4xl lg:text-[4rem] font-clash font-bold leading-none uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10">
          {courses.length === 0 ? (
            <div className="col-span-full py-20 text-center">
              <p className="text-xl text-gray-500 font-medium">No courses found in this category yet.</p>
            </div>
          ) : (
            courses.map((course, index) => (
              <motion.div
                ...
                <motion.img
                  ...
                  transition={smoothTransition}
                  src={course.image || "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&q=80&w=800"}
                ...
                <motion.div
                  ...
                  <div className="relative w-full md:w-5/12 h-64 md:h-auto overflow-hidden">
                    <motion.img
                      ...
                      src={selectedCourse.image || "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&q=80&w=800"}
                  ...
                  <div className="w-full md:w-7/12 p-8 md:p-12 overflow-y-auto custom-scrollbar">
                    ...
                    <p className="text-zinc-600 text-lg leading-relaxed mb-8">
                      {selectedCourse.fullDesc || selectedCourse.description}
                    </p>
